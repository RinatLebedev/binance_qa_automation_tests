...
def branch_cutted = task_branch.contains("all") ? task_branch.split('/')[1] : task_branch.trim()
currentBuild.displayName = "$branch_cutted"
base_git_url = "https://gitlab.com/rinatlebedev1/binance_qa_automation_tests.git"
